...
#        rospy.on_shutdown(self._on_node_shutdown)
        ...
        self.effectclient = actionlib.SimpleActionClient('/camera_effects', fake_camera_effects.msg.CameraEffectsAction)

        self.client.wait_for_server()
        self.brandclient.wait_for_server()
        with open(rospy.get_param("~texts"), "r") as text_file:
    ...
    def command_callback(self, msg):
        ...
        if command_msg == 'INFO_TERMINAL' :
            ...
            self.effectclient.send_goal(fake_camera_effects.msg.CameraEffectsGoal())
